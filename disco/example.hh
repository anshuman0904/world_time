...
#ifndef __Example_mHello__
#define __Example_mHello__
  class Hello;
  class _objref_Hello;
  class _impl_Hello;
...
_CORBA_MODULE_BEG
  ...
  class Hello :
    public virtual Example::_impl_Hello,
    public virtual ::PortableServer::ServantBase
  {
  public:
    virtual ~Hello();

    inline ::Example::Hello_ptr _this() {
      return (::Example::Hello_ptr) _do_this(::Example::Hello::_PD_repoId);
    }
  };
...
inline void
Example::Hello::_marshalObjRef(::Example::Hello_ptr obj, cdrStream& s) {
