...
INSTALLPYTHONDIR   := $(DESTDIR)${PYTHON_PREFIX}/lib/python3.12/site-packages
INSTALLPYEXECDIR   := $(DESTDIR)${PYTHON_EXEC_PREFIX}/lib/python3.12/site-packages
...
OMNI_MAKEFLAGS = $(filter -j%, $(MAKEFLAGS))
